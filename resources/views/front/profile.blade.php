                ...
                <div class="col-md-12 col-lg-12 col-xs-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>{{date('d-m-Y', strtotime($n->created_at))}}</th>
                                <th><span style="color: red">{{$n->message}}</span></th>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xs-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @forelse ($users as $key=>$r)
                                <tr>
                                    <td>{{++$key}}</td>
                                    <td>{{$r->name}}</td>
                                    <td>{{$r->email}}</td>
                                    <td>
                                        <form action="{{route('update',$r->id)}}" method="post" >
                                            @csrf
                                    ...
                                    <td>
                                        <a href="{{route('deleteUser',$r->id)}}" class="btn btn-danger" onclick="return confirm('Are You Sure!!')"><i class="fa-solid fa-trash"></i></a>
                                        {{-- {{$r->id}} --}}
                                    </td>
                                </tr>
                            @empty
